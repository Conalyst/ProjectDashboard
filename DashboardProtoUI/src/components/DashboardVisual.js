...
export const DashboardVisual = () => {
  ...
  const [highAssetConfidentiality, setHighAssetConfidentiality] =
    useState(null);
  const [mediumAssetConfidentiality, setMediumAssetConfidentiality] =
    useState(null);
  ...
  console.log(
    "###############",
    highAssetConfidentiality,
    mediumAssetConfidentiality,
    lowAssetConfidentiality
  );
      ...
      try {
        ...
        getStaticAssets()
          .then((res) => {
            ...
            setHighAssetAvailability(
              res.visual.highAssetAvailability[0].high_Asset
            );
            setHighAssetConfidentiality(
              res.visual.highAssetConfidentiality[0].high_Asset
            );
            setHighAssetIntegrity(res.visual.highAssetIntegrity[0].high_Asset);

            setMediumAssetAvailability(
              res.visual.mediumAssetAvailability[0].mediun_Asset
            );
            setMediumAssetConfidentiality(
              res.visual.mediumAssetConfidentiality[0].mediun_Asset
            );
            setMediumAssetIntegrity(
              res.visual.mediumAssetIntegrity[0].mediun_Asset
            );

            setLowAssetAvailability(
              res.visual.lowAssetAvailability[0].low_Asset
            );
            setLowAssetConfidentiality(
              res.visual.lowAssetConfidentiality[0].low_Asset
            );
            ...
            <div className="stack-bar-h">
              ...
              <div className="V-T-Color">
                <HSBar
                  ...
                  data={[
                    {
                      value: parseInt(highAssetConfidentiality),
                      name: "H",
                      description: `${highAssetConfidentiality}`,
                      color: "#09375f",
                    },
                    {
                      value: parseInt(mediumAssetConfidentiality),
                      name: "M",
                      description: `${mediumAssetConfidentiality}`,
                      color: "#126dba",
                    },
                    {
                      value: parseInt(lowAssetConfidentiality),
                      name: "L",
                      description: `${lowAssetConfidentiality}`,
                      color: "#72b7f2",
                    },
                  ]}
                />
            ...
            <div className="stack-bar-h">
              ...
              <div className="V-T-Color">
                <HSBar
                  ...
                  data={[
                    {
                      value: parseInt(highAssetIntegrity),
                      name: "H",
                      description: `${highAssetIntegrity}`,
                      color: "#09375f",
                    },
                    {
                      value: parseInt(mediumAssetIntegrity),
                      name: "M",
                      description: `${mediumAssetIntegrity}`,
                      color: "#126dba",
                    },
                    {
                      value: parseInt(lowAssetIntegrity),
                      name: "L",
                      description: `${lowAssetIntegrity}`,
                      color: "#72b7f2",
                    },
                  ]}
                />
            ...
            <div className="stack-bar-h">
              ...
              <div className="V-T-Color">
                <HSBar
                  ...
                  data={[
                    {
                      value: parseInt(highAssetAvailability),
                      name: "H",
                      description: `${highAssetAvailability}`,
                      color: "#09375f",
                    },
                    {
                      value: parseInt(mediumAssetAvailability),
                      name: "M",
                      description: `${mediumAssetAvailability}`,
                      color: "#126dba",
                    },
                    {
                      value: parseInt(lowAssetAvailability),
                      name: "L",
                      description: `${lowAssetAvailability}`,
                      color: "#72b7f2",
                    },
                  ]}
                />
