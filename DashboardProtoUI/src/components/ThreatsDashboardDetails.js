...
export const ThreatsDashboardDetails = () => {
      ...
      tempThreats
        ...
        .filter(
          sel.selThreatAgent != "All"
            ? (tempThreats) => tempThreats.agent.toLowerCase().includes(sel.selThreatAgent)
  ...
  function reduceDupFilterAgent() {
    ...
    setAgentArray(threatsAgentList.filter((item, index) => threatsAgentList.indexOf(item) === index));
  }
                  ...
                  <Dropdown.Menu className="filter_dropdown">
                    ...
                    {agentArray
                      .map((f) => (
                        ...
                        <li onClick={() => setSel((prev) => ({ ...prev, selThreatAgent: f.toLowerCase() }))}>{f.toLowerCase()}</li>
                      ))}
                  </Dropdown.Menu>
                </Dropdown>
                {/*  =========================================== filter the agent  */}
          ...
          <tbody>
            ...
            {tempThreats.map((threat) => (
              <tr className="cr-text">
                ...
                <td>{threat.rating}</td>
                <td>
                  <button className="pen-button" onClick={onEditThreat}>
