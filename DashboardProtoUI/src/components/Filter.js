  ...
  return (
    <>
      ...
      <div className="Filter-Main-3">
        ...
        <div className="Rectangle-935"><span className="Network-Data-Center"> Data</span>
        </div>
        <div className="Rectangle-935"><span className="Network-Data-Center"> Intangible</span>
        </div>
        <div className="Rectangle-935"><span className="Network-Data-Center"> Network Data Center</span>
        </div>
        <div className="Rectangle-935"><span className="Network-Data-Center"> Personal</span>
        </div>
        <div className="Rectangle-935"><span className="Network-Data-Center"> Software</span>
        </div>
        <div className="Button-Primary-Done">Done</div>
      </div>
    </>
  )
}
