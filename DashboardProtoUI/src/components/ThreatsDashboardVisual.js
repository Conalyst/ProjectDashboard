      ...
      <div className="row g-2 visual-rating-threat">
        <div className=" col-4">
          ...
          {agentsRating.map((agent) => (
            <div className="Rectangle-1407">
              {/* <span className="Phishing">{agent.agent}</span> */}
        ...
        <div className="col-4">
          ...
          <div className="V-T-Color">
            ...
            <div className="label-span-s">
              <span className="value-span-s span-H-s">
                H({highThreatsImpact})
              </span>
              <span className="value-span-s span-M-s">
                M({mediumThreatsImpact})
              </span>
              <span className="value-span-s span-L-s">
                L({lowThreatsImpact})
              </span>
            </div>
          </div>
          ...
          {agentsImpact.map((agent) => (
            // <div div className="Rectangle-1407-Mal">
              ...
              {/* <span className="Malware">{agent.agent}</span> */}
              <span className="text-thr ">{agent.agent}</span>
            </div>
          ))}
        </div>
        ...
        <div className="col-4">
          ...
          {agentsLikelihood.map((agent) => (
            // <div className="Rectangle-1408-Fin">
                 <div className="Rectangle-1407">
              {/* <span className="Financial-Fraud">{agent.agent}</span> */}
              <span className="text-thr ">{agent.agent}</span>
            </div>
          ))}
        </div>
