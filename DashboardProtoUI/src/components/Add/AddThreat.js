...
import { THREATSDASHBOARD, VULDASHBOARD } from "../../navigation/CONSTANTS.js";
              ...
              <div className="modal-content Manage-list-add">
                <div className="modal-header Rectangle-header">
                  ...
                  <div className="modal-body">
                    <p className="New-asset-was-successfully-added-to-the-list">New threat was successfully added to the list.</p>
