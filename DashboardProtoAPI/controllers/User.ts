...
export class UserApi{
    ...
    async create(req: express.Request, res: express.Response){
        ...
        const alreadyExistsUser = await this._userRepository.GetUserByemail(email).catch(
        (err) => {
    ...
    getDtoFromRequest(req: express.Request){
        ...
        return new UserDto(req.body.id, req.body.name,req.body.email, req.body.password,  req.body.companyId, req.body.roleId,new Date());
    }
